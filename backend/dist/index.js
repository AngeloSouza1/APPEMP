...
app.get("/admin/monitoramento/cloudinary/status", async (req, res) => {
    var _a, _b;
    if (((_a = req.user) === null || _a === void 0 ? void 0 : _a.perfil) !== "admin" && ((_b = req.user) === null || _b === void 0 ? void 0 : _b.perfil) !== "backoffice") {
    ...
    try {
        ...
        return res.status(400).json({
            ok: false,
            enabled: true,
            reason: (error === null || error === void 0 ? void 0 : error.message) || "Falha ao consultar o status do armazenamento.",
        });
    }
});
