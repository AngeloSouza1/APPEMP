...
const styles = StyleSheet.create({
  ...
  kpiLabel: { color: '#475569', fontSize: 12, fontWeight: '700' },
  kpiValue: { color: '#1e3a8a', fontSize: 15, fontWeight: '900', marginTop: 2 },
  sectionCard: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#dbeafe',
  ...
  sectionMeta: { color: '#475569', fontSize: 12, fontWeight: '700' },
  itemCard: {
    borderRadius: 10,
    borderWidth: 1,
    borderColor: '#dbeafe',
  ...
  itemTitle: { flex: 1, color: '#0f172a', fontSize: 15, fontWeight: '900' },
  itemValue: { color: '#1d4ed8', fontSize: 15, fontWeight: '900' },
