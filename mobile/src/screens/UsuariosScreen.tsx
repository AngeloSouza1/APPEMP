...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 39.27 / 1.5, fontWeight: '800', color: '#0f172a' },
  headerIconButton: {
    minWidth: 82,
    height: 38,
    borderRadius: 11,
  ...
  headerIconText: { color: '#1e3a8a', fontWeight: '800', fontSize: 17.33 },
  headerAddButton: {
    width: '100%',
    height: 48,
    borderRadius: 11,
  ...
  headerAddIcon: { color: '#fff', fontSize: 16.17, fontWeight: '800' },
  headerAddText: { color: '#fff', fontSize: 15.02, fontWeight: '800' },
  filtersCard: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#bfdbfe',
  ...
  filterRow: { rowGap: 6 },
  filterLabel: { fontSize: 13.86, color: '#334155', fontWeight: '700' },
  ...
  chipText: { fontSize: 13.86, color: '#475569', fontWeight: '600' },
  ...
  refreshButtonText: { color: '#334155', fontWeight: '700', fontSize: 13.86 },
  totalText: { fontSize: 13.86, color: '#334155', fontWeight: '700' },
  ...
  userTextWrap: { flex: 1 },
  userName: { fontSize: 18.48, fontWeight: '800', color: '#0f172a' },
  userLogin: { fontSize: 13.86, color: '#64748b', marginTop: 1 },
  statusBadge: {
    borderRadius: 999,
    borderWidth: 1,
    paddingHorizontal: 9,
  ...
  metaText: { color: '#334155', fontSize: 15.02, fontWeight: '600' },
  editLink: { color: '#1d4ed8', fontSize: 15.02, fontWeight: '700' },
  ...
  warningTitle: { fontSize: 19.64, fontWeight: '800', color: '#713f12' },
  ...
  modalTitle: { fontSize: 20.79, fontWeight: '800', color: '#0f172a' },
