...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 35.7 / 1.5, fontWeight: '800', color: '#0f172a' },
  headerIconButton: {
    minWidth: 82,
    height: 38,
    borderRadius: 11,
  ...
  headerIconText: { color: '#1e3a8a', fontWeight: '800', fontSize: 15.75 },
  headerAddButton: {
    width: '100%',
    height: 48,
    borderRadius: 11,
  ...
  headerAddIcon: { color: '#fff', fontSize: 14.7, fontWeight: '800' },
  headerAddText: { color: '#fff', fontSize: 13.65, fontWeight: '800' },
  filtersCard: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#bfdbfe',
  ...
  filterRow: { rowGap: 6 },
  filterLabel: { fontSize: 12.6, color: '#334155', fontWeight: '700' },
  ...
  chipText: { fontSize: 12.6, color: '#475569', fontWeight: '600' },
  ...
  refreshButtonText: { color: '#334155', fontWeight: '700', fontSize: 12.6 },
  totalText: { fontSize: 12.6, color: '#334155', fontWeight: '700' },
  ...
  userTextWrap: { flex: 1 },
  userName: { fontSize: 16.8, fontWeight: '800', color: '#0f172a' },
  userLogin: { fontSize: 12.6, color: '#64748b', marginTop: 1 },
  statusBadge: {
    borderRadius: 999,
    borderWidth: 1,
    paddingHorizontal: 9,
  ...
  metaText: { color: '#334155', fontSize: 13.65, fontWeight: '600' },
  editLink: { color: '#1d4ed8', fontSize: 13.65, fontWeight: '700' },
  ...
  warningTitle: { fontSize: 17.85, fontWeight: '800', color: '#713f12' },
  ...
  modalTitle: { fontSize: 18.9, fontWeight: '800', color: '#0f172a' },
